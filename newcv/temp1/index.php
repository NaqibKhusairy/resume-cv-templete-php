            ...
            <center>
                <table>
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="lang1" placeholder="1" required>
                        </td>
                        <td class="col3" colspan="9">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="lang2" placeholder="2">
                        </td>
                        <td class="col3" colspan="9">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="lang3" placeholder="3">
                        </td>
                        <td class="col3" colspan="9">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="expertise1" placeholder="1" required>
                        </td>
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="expertise2" placeholder="2">
                        </td>
                        <td class="col3" colspan="9">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="expertise3" placeholder="3">
                        </td>
                        <td class="col3" colspan="9">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="expertise4" placeholder="4">
                        </td>
                        <td class="col3" colspan="9">
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2">
                            <input type="text" name="expertise5" placeholder="5">
                        </td>
                        <td class="col3" colspan="9"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="col2"></td>
                        <td class="col3">
                            <input type="text" name="skill1" placeholder="1" required>
                        </td>
                        <td class="col4">
                    ...
                    <tr>
                        ...
                        <td class="col2"></td>
                        <td class="col3">
                            <input type="text" name="skill2" placeholder="2">
                        </td>
                        <td class="col4">
                    ...
                    <tr>
                        ...
                        <td class="col2"></td>
                        <td class="col3">
                            <input type="text" name="skill3" placeholder="3">
                        </td>
                        <td class="col4">
                            <progress id="progress3" value="0" max="100"></progress>
                        </td>
                        <td class="col5" colspan="8">
                            <input type="number" name="percent3" id="percent3" placeholder="81" max="100" min="0">
                        </td>
                    </tr>
                    <tr>
                        <td class="col1"></td>
                        <td class="col2"></td>
                        <td class="col3">
                            <input type="text" name="skill4" placeholder="4">
                        </td>
                        <td class="col4">
                            <progress id="progress4" value="0" max="100"></progress>
                        </td>
                        <td class="col5" colspan="8">
                            <input type="number" name="percent4" id="percent4" placeholder="81" max="100" min="0">
                        </td>
                    </tr>
                    <tr>
