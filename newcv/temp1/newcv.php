    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
       ...
       if (isset($_FILES["profile_image"]) && $_FILES["profile_image"]["error"] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($temp_image, $new_image_path)) {
                $image = "<p>Profile Image: <img src='$new_image_path' class='round-image' alt='Profile Image'></p>";
            }
        }
        else{
                ...
                <table>
                    ...
                    <tr class="raw2">
                        ...
                        <td class="raw2" rowspan="3">
                            <img class="round-image" src="<?php echo $new_image_path;?>" alt="Profile Image"> <!--input from user-->
                        </td>
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2"><?php echo $phone;?></td> <!--input from user-->
                        <?php
                            if($company_name2 !=""){
                        ?>
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2"><?php echo $email;?></td> <!--input from user-->
                        <?php
                            if($company_name2 !=""){
                        ?>
                    ...
                    <tr>
                        <td class="col1"></td>
                        <td class="col2"><?php echo $address;?></td> <!--input from user-->
                        <?php
                            if($company_name2 !=""){
                        ?>
